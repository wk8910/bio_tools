...
my @vcf=<02.vcfByWind/*.vcf.gz>;
my $out="gatk_snp.vcf.gz";
my $non_repeat="/home/share/user/user101/projects/yangshu/16.angsd/01.regions_without_repeat/01.generate_sites.pl.txt";
