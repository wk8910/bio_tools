...
# nuPre,TPre,nu1,nu2,T1,T2,f

func = custom_model.custom_model

upper_bound = [10,1,10,10,1,1,0.1]
lower_bound = [1e-3,1e-3,1e-3,1e-3,1e-3,1e-3,0]
...
print('likelihood\ttheta\tN.nuPre\tT.Tpre\tN.nu1\tN.nu2\tT.T1\tT.T2\tO.f')
