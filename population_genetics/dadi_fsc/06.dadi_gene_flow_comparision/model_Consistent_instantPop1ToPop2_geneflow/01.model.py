...
# nuPre,TPre,nu1,nu2,T1,T2,m12,m21,f

func = custom_model.custom_model

upper_bound = [10,1,10,10,1,1,10,10,0.1]
lower_bound = [1e-3,1e-3,1e-3,1e-3,1e-3,1e-3,1e-3,1e-3,0]
...
print('###DADIOUTPUT###')
# nuPre,TPre,nu1,nu2,T,f
print('likelihood\ttheta\tN.nuPre\tT.Tpre\tN.nu1\tN.nu2\tT.T1\tT.T2\tM.m12\tM.m21\tO.f')
